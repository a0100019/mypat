...
fun getUserInitialData(): List<User> {
    return listOf(
        ...
        User(id = "selectPat"), // 1 selectPat 2 오늘 광고 날짜 3 익명로그인=1
        User(id = "money", value = "0", value2 = "500"),
        User(id = "pat", value = "5", value2 = "5", value3 = "1"), // 1-최종 개수, 2-오픈 개수, 3-사용 개수
        User(id = "item", value = "10", value2 = "10", value3 = "1"),
