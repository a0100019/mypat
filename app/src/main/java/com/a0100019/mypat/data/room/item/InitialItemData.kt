...
fun getItemInitialData(): List<Item> {
    return listOf(
        ...
        Item( name = "해변", memo = "해변이다.", date = "1", url = "area/beach.jpg", type = "area"),
        Item( name = "숲", memo = "숲이다.", date = "1", url = "area/forest.jpg", type = "area"),
        Item( name = "숲", memo = "숲이다.", url = "area/forest.jpg", type = "area")
